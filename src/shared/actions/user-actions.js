...
export const setFakeUser = () => dispatch => {
  dispatch({ type: "SET_FAKE_USER" });
};

// get single User
export const getUserRequest = () => ({ type: A.GET_USER_REQUEST });
export const getUserSuccess = payload => ({
  type: A.GET_USER_SUCCESS,
  payload
});
...
export const getUser = signinName => {
  return dispatch => {
    ...
    return axios
      .get(apiUrl.USERS_ROUTE + "/" + signinName, config)
      .then(response => {
...
export const updateUser = (currentSigninName, user) => {
  return dispatch => {
    ...
    return axios
      .post(apiUrl.USERS_ROUTE + "/" + currentSigninName, user)
      .then(() => {
...
export const deleteUser = signinName => {
  return dispatch => {
    ...
    return axios
      .delete(apiUrl.USERS_ROUTE + "/" + signinName)
      .then(() => {
