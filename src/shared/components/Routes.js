  ...
  render() {
    ...
    return (
      <Switch>
        <PrivateRoute
          exact
          path={[publicPath, routeCodes.DASHBOARD]}
          isAuthed={isAuthed}
          component={DashboardContainer}
        />
        <PrivateRoute
          path={routeCodes.BROWSE}
          isAuthed={isAuthed}
          component={BrowseContainer}
        />
        <PrivateRoute
          path={routeCodes.MANAGE_PROJECTS}
          isAuthed={isAuthed}
          component={ManageProjectsContainer}
        />
        <PrivateRoute
          path={routeCodes.NEW_PROJECT}
          isAuthed={isAuthed}
          component={NewProjectContainer}
        />
        <PrivateRoute
          path={"/:projectName" + routeCodes.EDIT}
          isAuthed={isAuthed}
          component={EditProjectContainer}
        />
        <PrivateRoute
          path={"/:projectName" + routeCodes.NEW_TICKET}
          isAuthed={isAuthed}
          component={NewTicketContainer}
        />
        <PrivateRoute
          path={"/:projectName" + "/:ticketName" + routeCodes.NEW_VIDEO}
          isAuthed={isAuthed}
          component={NewVideoContainer}
        />
        <PrivateRoute
          path={"/:projectName" + "/:ticketName" + "/:videoName"}
          isAuthed={isAuthed}
          component={VideoPageContainer}
        />
        <PrivateRoute
          exact
          path={"/:projectName" + "/:ticketName"}
          isAuthed={isAuthed}
